window.onload = function(){
    ...
    var name = "Margo";
    var menuBtn = document.querySelector('.top-nav_btn');
    var menu = document.querySelector('.top-nav_menu');
    ...
    var sidebarBtn = document.querySelector('.left-sidebar_btn');
    var sidebarMenu = document.querySelector('.left-sidebar_menu');
